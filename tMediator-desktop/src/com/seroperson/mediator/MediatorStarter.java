...
public class MediatorStarter extends JFrame {
	
	private Image icon;
	private final Point location = new Point();
	private final Mediator mediator;
	
	public MediatorStarter(String... args) { 
		super("tMediator");
		final int w = 360/2;
		final int h = 360/2;
			
		final TrayIcon tray = initTray();
		final boolean debug = (args.length > 0 && (args[0].equals("-d") || args[0].equals("--debug")));
		mediator = new MediatorDesktop(debug ? Mediator.debugInitialization : Mediator.defaultInitialization, this, tray);		
	   ...
	   JComponent c = (JComponent)getContentPane();  
		...
		Settings settings = Mediator.getMediator().getSettings();
		...
		addComponentListener(new ComponentAdapter() {
			...
			public void componentResized(ComponentEvent e) {
				com.sun.awt.AWTUtilities.setWindowShape(MediatorStarter.this, crr);
			}
		});
	...
	private TrayIcon initTray() { 
        ...
        settings.addActionListener(new ActionListener() {
            @Override
			public void actionPerformed(ActionEvent e) {
            	new com.seroperson.mediator.settings.SettingsSaver(Mediator.getMediator().getSettings());
            }
        });
